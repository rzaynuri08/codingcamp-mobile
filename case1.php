...
$tanahYuwan = new Lingkaran(3);
$tanahRagiel = new PersegiPanjang(3 ,5);

echo "Tanah Yuwan Seluas".$tanahYuwan->hitungLuas()."m2 <br>";
echo $tanahYuwan->ditanami(). "<br>";

echo "Tanah Ragiel Seluas".$tanahRagiel->hitungLuas()."m2 <br>";
echo $tanahRagiel->ditanami() ."<br>";
